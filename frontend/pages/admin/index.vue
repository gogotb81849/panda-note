<template>
  <div class="admin-dashboard">
    ...
    <div class="admin-cards">
      <NuxtLink to="/admin/menu-config" class="admin-card">
      ...
      <NuxtLink to="/admin/monitor" class="admin-card">
      ...
      <NuxtLink to="/admin/export" class="admin-card">
      ...
      <NuxtLink to="/admin/ops" class="admin-card">
      ...
      <NuxtLink to="/admin/staff-assignments" class="admin-card">
