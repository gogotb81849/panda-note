...
> ⚠️⚠️⚠️ **【每次优化前必读】请先打开 /workspace/panda-note/优化前提说明文档.md 从头完整读一遍，所有强约束、工作流、自检清单都在那个文档里。本文档是精简版本，详细规则以优化前提说明文档.md 为准。下次一定要看优化前提说明文档！永远都要看！**
...
> 详细流程、打勾清单见 /workspace/panda-note/优化前提说明文档.md

1. **先读文档**：打开 /workspace/panda-note/优化前提说明文档.md 从头读到尾
...
> ⚠️ **最后提醒：下次优化前一定要先读 /workspace/panda-note/优化前提说明文档.md！每一次都要读！记忆一直传承下去！**